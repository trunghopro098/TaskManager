...
export default function Splash({navigation}){
    ...
    useEffect(()=>{
        ...
        const u = await AsyncStorage.getItem("NAME")
        if(u !== null){
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                >
                    ...
                    <Animated.View style={{...styles.logoContainer,alignItems:"center", }}>
                        <Text style={{ ...styles.logoText,fontSize : 20}}> PERSONAL </Text>
                        <Animated.Text style={{...styles.logoText,color : "#295A8A", paddingTop : 4}}>TASK MANAGER</Animated.Text>
                    </Animated.View>
                </View>
            </SafeAreaView>
        )
